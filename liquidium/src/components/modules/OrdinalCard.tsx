...
const OrdinalCard: FC<OrdinalCardProps> = ({
  ...
  return (
    <div className={cn(
      "w-[187px] max-[425px]:w-[220px] h-[318px] bg-[#141414] rounded-[20px] p-4 flex flex-col items-center",
      className
    )}>
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <p className="text-[#7D7D7D] text-[12px] truncate">Name: {ordinal.inscription_name}</p>
        <p className="text-[#7D7D7D] text-[12px] truncate">ID: {ordinal.inscription_id.substring(0, 8)}...</p>
        <p className="text-[#7D7D7D] text-[12px] truncate">Number: {ordinal.inscription_number}</p>
