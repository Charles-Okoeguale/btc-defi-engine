        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="bg-[#0A0A0A] text-white border border-[#2B2B2B] p-4 sm:p-6 
                ...
                <div className='border border-[#4B4B4B] rounded-[20px] p-3 sm:p-4 bg-[#0A0A0A]'>
                    <DialogHeader>
                        <DialogTitle className="font-bold text-[14px] sm:text-[16px] mb-2">
                            Edit custom request
                        </DialogTitle>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 sm:gap-2'>
                            ...
                            <div className='flex-1 space-y-2'>
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-white text-[12px]">{ordinalData.ordinal.collection.name}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-[#7D7D7D] text-[12px]">Name:</span>
                                    <span className="text-white text-[12px]">{ordinalData.ordinal.name}</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-white text-[12px]">{ordinalData.ordinal.inscriptionNumber}</span>
                                </div>
                            </div>
                        </div>
                    </DialogHeader>
